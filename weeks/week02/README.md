...
**ML focus:** Distributions & correlation

**Notebook:** [`notebooks/week02_eda.ipynb`](../../notebooks/week02_eda.ipynb) · [Colab workflow](../../docs/GOOGLE_COLAB.md)

## Goal for this meeting

Advance the **shared project** — not a separate assignment. By adjournment:

**Notebook holds 3 plots + insight bullets**
