...
**ML focus:** Ethics, Slides, rehearsal

**Notebook:** [`notebooks/week08_showcase.ipynb`](../../notebooks/week08_showcase.ipynb) · [Colab workflow](../../docs/GOOGLE_COLAB.md)

## Goal for this meeting

Advance the **shared project** — not a separate assignment. By adjournment:

**Slides linked; dry-run demo**
