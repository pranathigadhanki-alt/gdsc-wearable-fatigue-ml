# Session 5: Model compare

**ML focus:** Logistic vs Random Forest

**Notebook:** [`notebooks/week05_model_compare.ipynb`](../../notebooks/week05_model_compare.ipynb) · [Colab workflow](../../docs/GOOGLE_COLAB.md)

## Goal for this meeting

Advance the **shared project** — not a separate assignment. By adjournment:

**Comparison table; pick model family**
